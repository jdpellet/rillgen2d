...
long count,*topovecind,*flatis,*flatjs,*iup,*idown,*jup,*jdown,lattice_size_x,lattice_size_y,ic,jc,i,j,m,n,result;
int flagfordynamicmode,numberofraindata,numberofraingages,**closestgage,expansion,smoothinglength,numberofdatapoints,flagforrainrasters,flagforequation,flagfordynamicmode,flagformask,flagforslope,flagford50,flagfortaucsoilandveg,flagforrain,flagforcu,flagforthickness,flagforrockcover,**mask,hydrologic,dynamic;
